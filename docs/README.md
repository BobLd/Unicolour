...
| ![Gradient of purple to orange through many colour spaces, created with Unicolour](gradient-spaces-purple-orange.png) | ![Gradient of black to green through many colour spaces, created with Unicolour](gradient-spaces-black-green.png) |
|----------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
...
| ![Visualisation of temperature from 1,000 K to 13,000 K, created with Unicolour](gradient-temperature.png) |
|-----------------------------------------------------------------------------------------------------------------|
...
| ![Perceptually uniform colourmaps from Unicolour.Datasets, created with Unicolour](gradient-maps.png) | ![Perceptually uniform colour palettes from Unicolour.Datasets, created with Unicolour](gradient-maps-palette.png) |
|------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
